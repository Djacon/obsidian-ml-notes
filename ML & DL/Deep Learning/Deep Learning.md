**Deep Learning (DL)**  is a subset of [[machine learning]] (ML) that learns features and tasks directly from [[data]]. Inputs are run through [[neural networks]]. Learning can be supervised, semi-supervised or unsupervised
