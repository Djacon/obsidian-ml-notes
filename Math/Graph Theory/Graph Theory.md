**Graph theory** is the study of [[graph|graphs]], which are [[math]] structures used to model pairwise relations between objects. A graph in this context is made up of vertices ($V$) which are connected by edges ($E$)
